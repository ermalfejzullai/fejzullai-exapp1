...
const Invoice = React.forwardRef((props, ref) => {
    const { selectedCurrency, amount, result, currencyValue } = props;
    ...
    return (
        <div ref={ref}>
            <div className='page'>
                ...
                <p className='type'>Shitje/Продавам</p>
                ...
                <table className='table'>
                    <tr className='noborder'>
                        ...
                        <td className='table-cell'><p className='headers'>Totali Вкупно EUR</p></td>

                    </tr>
                    <tr>
                        <td className='table-cell'>MKD</td>
